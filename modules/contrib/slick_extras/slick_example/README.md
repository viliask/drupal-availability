...
These fields must exist **before installing Slick Example**:

1. field_image (single value)
2. field_images (multi value)

Create a new content type, **Slideshow** (or the existing like Article, etc.)
