...
class SocialContactInfo extends BlockBase implements BlockPluginInterface {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['contact_detail']['contact_title'] = [
      ...
      '#default_value' => isset($this->configuration['contact_detail']['contact_title']) ? $this->configuration['contact_detail']['contact_title'] : '',
    ];
    // Address details.
    ...
    $form['contact_detail']['address']['label'] = [
      ...
      '#default_value' => isset($this->configuration['contact_detail']['address']['label']) ? $this->configuration['contact_detail']['address']['label'] : '',
    ];
    $form['contact_detail']['address']['value'] = [
      ...
      '#resizable' => FALSE,
      '#format' => 'full_html',
      '#default_value' => isset($this->configuration['contact_detail']['address']['value']['value']) ? $this->configuration['contact_detail']['address']['value']['value'] : '',
    ];
    ...
    $form['contact_detail']['email']['label'] = [
      ...
      '#title' => $this->t('Label'),
      '#description' => $this->t('Enter your label (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['email']['label']) ? $this->configuration['contact_detail']['email']['label'] : '',
    ];
    $form['contact_detail']['email']['value'] = [
      '#type' => 'textfield',
      '#title' => $this->t('E-mail'),
      '#description' => $this->t('Enter your email address (Required).'),
      '#default_value' => isset($this->configuration['contact_detail']['email']['value']) ? $this->configuration['contact_detail']['email']['value'] : '',
    ];
    ...
    $form['contact_detail']['phone']['label'] = [
      ...
      '#title' => $this->t('Label'),
      '#description' => $this->t('Enter your label (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['phone']['label']) ? $this->configuration['contact_detail']['phone']['label'] : '',
    ];
    $form['contact_detail']['phone']['value'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Phone'),
      '#description' => $this->t('Enter your phone number (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['phone']['value']) ? $this->configuration['contact_detail']['phone']['value'] : '',
    ];
    ...
    $form['contact_detail']['mobile']['label'] = [
      ...
      '#title' => $this->t('Label'),
      '#description' => $this->t('Enter your label (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['mobile']['label']) ? $this->configuration['contact_detail']['mobile']['label'] : '',
    ];
    $form['contact_detail']['mobile']['value'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Mobile'),
      '#description' => $this->t('Enter your mobile number (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['mobile']['value']) ? $this->configuration['contact_detail']['mobile']['value'] : '',
    ];
    ...
    $form['contact_detail']['fax']['label'] = [
      ...
      '#title' => $this->t('Label'),
      '#description' => $this->t('Enter your label (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['fax']['label']) ? $this->configuration['contact_detail']['fax']['label'] : '',
    ];
    $form['contact_detail']['fax']['value'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Fax'),
      '#description' => $this->t('Enter your fax number (Optional).'),
      '#default_value' => isset($this->configuration['contact_detail']['fax']['value']) ? $this->configuration['contact_detail']['fax']['value'] : '',
    ];
    ...
    $form['social_detail']['social_title'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['social_title']) ? $this->configuration['social_detail']['social_title'] : '',
    ];
    // Facebook details.
    ...
    $form['social_detail']['facebook']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['facebook']['link']) ? $this->configuration['social_detail']['facebook']['link'] : '',
    ];
    $form['social_detail']['facebook']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['facebook']['class']) ? $this->configuration['social_detail']['facebook']['class'] : '',
    ];
    ...
    $form['social_detail']['linkedin']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['linkedin']['link']) ? $this->configuration['social_detail']['linkedin']['link'] : '',
    ];
    $form['social_detail']['linkedin']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['linkedin']['class']) ? $this->configuration['social_detail']['linkedin']['class'] : '',
    ];
    ...
    $form['social_detail']['twitter']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['twitter']['link']) ? $this->configuration['social_detail']['twitter']['link'] : '',
    ];
    $form['social_detail']['twitter']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['twitter']['class']) ? $this->configuration['social_detail']['twitter']['class'] : '',
    ];
    ...
    $form['social_detail']['youtube']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['youtube']['link']) ? $this->configuration['social_detail']['youtube']['link'] : '',
    ];
    $form['social_detail']['youtube']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['youtube']['class']) ? $this->configuration['social_detail']['youtube']['class'] : '',
    ];
    ...
    $form['social_detail']['pinterest']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['pinterest']['link']) ? $this->configuration['social_detail']['pinterest']['link'] : '',
    ];
    $form['social_detail']['pinterest']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['pinterest']['class']) ? $this->configuration['social_detail']['pinterest']['class'] : '',
    ];
    ...
    $form['social_detail']['instagram']['link'] = [
      ...
      '#default_value' => isset($this->configuration['social_detail']['instagram']['link']) ? $this->configuration['social_detail']['instagram']['link'] : '',
    ];
    $form['social_detail']['instagram']['class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Class Name'),
      '#description' => $this->t('Enter your custom/fonts CSS classes (Optional).'),
      '#default_value' => isset($this->configuration['social_detail']['instagram']['class']) ? $this->configuration['social_detail']['instagram']['class'] : '',
    ];
